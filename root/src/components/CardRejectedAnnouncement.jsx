...
const CardRejectedAnnouncement = ({ singleData, isLoading }) => {
    ...
    return (
        ...
        <div className='border mx-4 my-2 myCursor' onClick={()=>setMinimize(!minimize)}>
            ...
            <div className='p-3 bg-light ' style={{ borderLeft: "3px solid red" }}>
                    ...
                    <div>
                        {
                            !singleData[0] || isLoading ?
                                <Placeholder animation="glow"><Placeholder xs={12} style={{ height: '400px' }} /></Placeholder> : <img className='myMaxW300' src={`http://localhost:5050/uploads/${singleData[0].pics}`} alt="" />
                        }
                    </div>
